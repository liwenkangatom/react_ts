...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    devtool: isEnvProduction
      ...
      : isEnvDevelopment && "cheap-module-source-map", // These are the "entry points" to our application.
    ...
    plugins: [
      ...
      isEnvProduction &&
        ...
        new InlineChunkHtmlPlugin(HtmlWebpackPlugin, [/runtime~.+[.]js/]), // Makes some environment variables available in index.html.
